...
The gap narrows at $\lambda=0$, but does not close: a residual $0.026$ $R^2$ gap to the DNN
remains on 4survey even with the physics/trajectory loss fully removed. What causes that residual
gap is not established here.
