...
# plan, the 15 documented pitfalls, and why this lives here instead of editing the original file.
#
...
#
# ISOLATION: this file is never imported by anything under models/, and nothing under models/ or
# outputs/ is edited to produce it. Original file untouched, byte-for-byte, except for the
# changes marked "FIX:" below.
