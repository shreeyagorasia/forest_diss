...
#
# Run as: PYTHONPATH=. .venv/bin/python temp_results_pinn/pinn_env_terrain_fix/run_full_rerun.py
...
OUTPUT_DIR = Path(__file__).resolve().parents[1] / "outputs" / "full_rerun"
...
def run_one_fold(fold_index):
    ...
    t0 = time.time()
    from temp_results_pinn.pinn_env_terrain_fix.pinn_env_terrain_fix import fit as fit_ymax
    from temp_results_pinn.pinn_env_terrain_fix.pinn_env_terrain_fix import predict as predict_ymax
    ...
    t0 = time.time()
    from temp_results_pinn.pinn_env_terrain_fix.pinn_env_terrain_k_fix import fit as fit_k
    from temp_results_pinn.pinn_env_terrain_fix.pinn_env_terrain_k_fix import predict as predict_k
