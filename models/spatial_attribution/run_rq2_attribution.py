...
def main():
    ...
    parser.add_argument(
        ...
        choices=[
            "nested_set1_baseline",  # added 2026-08-13: baseline-only comparison, see the
            # CanopyCover reverse-causation check in documentation/research_questions_overview.md
