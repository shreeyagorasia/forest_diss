# MIGRATED 2026-08-25 from temp_results_pinn/pinn_env_terrain_fix/pinn_env_terrain_k_fix.py into
# models/, alongside pinn_env_terrain_fix.py. Byte-identical to the original except for this
# header and one import path (chapman_richards_value now comes from the co-located
# models/pinn_env_terrain_fix/pinn_env_terrain_fix.py instead of the temp_results_pinn copy) --
...
from models.pinn_env_terrain_fix.pinn_env_terrain_fix import chapman_richards_value
