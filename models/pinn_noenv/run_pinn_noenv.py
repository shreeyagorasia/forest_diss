...
def run_for_cohort(
    ...
    learning_rate=LEARNING_RATE, dropout_rate=0.0, hidden_layer_sizes=None, split_seed=SPLIT_SEED,
...
def main():
    ...
    parser.add_argument(
        "--split-type", choices=["temporal", "spatial_block", "spatial_block_kfold", "temporal_narrow_gap", "plot_level"], default="temporal"
    )
