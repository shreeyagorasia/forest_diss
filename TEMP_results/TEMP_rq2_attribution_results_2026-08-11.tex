...
**Not yet done**: XGBoost SHAP values (deferred, needs the raw-column `compute_shap_values()`
variant), cross-method agreement heatmap (NLME vs. EN vs. XGBoost), 5-seed reseed (no seed
sweep has been run for RQ2 at all — this note only ever reflects split seed 42).
